            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="detail-value">${utils.formatDate(equipo.ultimo_mantenimiento)}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Próximo Mantenimiento</span>
                        <span class="detail-value">${utils.formatDate(equipo.proximo_mantenimiento)}</span>
                    </div>
                </div>
            </div>
            ...
            <form id="equipoForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-input" name="ultimo_mantenimiento" value="${equipo.ultimo_mantenimiento}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Próximo Mantenimiento</label>
                        <input type="date" class="form-input" name="proximo_mantenimiento" value="${equipo.proximo_mantenimiento}">
                    </div>
                </div>
